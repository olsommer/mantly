...
- Never describe a pending investigation, review, request, case, or action as being "to process", "to issue", "to approve", "to apply", "to provide", or "to grant" a requested credit, refund, or waiver. Unless exact successful action evidence proves it, state that eligibility and any amount remain unverified and unapproved.
