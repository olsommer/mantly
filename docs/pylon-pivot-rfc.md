...
- Admin test message: `POST /api/admin/projects/{project_id}/channels/{channel_id}/test-message` injects a normalized message through the same channel webhook ingestion path and returns the created ticket/message IDs.
